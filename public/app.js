...
function station(id) {
  ...
  return app.state.world.stationIndex[key]
    || dedupedStations(app.state.world.stations).find(s => s.id === key)
    || { id: key, code: key, name: key || 'Gare inconnue', lat: 0, lon: 0, baseDemand: 0, freight: 0, tourism: 0, region: 'Référence manquante', missing: true };
}
