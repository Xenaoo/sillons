...
const PROJECT_VERSION = 'v69.2.3';
const STATE_SCHEMA_VERSION = 165;
...
const SNCF_RFN_ROUTE_CACHE_VERSION = 'rfn-route-v16';
...
const SILLON_CAPACITY_MODEL_VERSION = 'sillon-capacity-v1';
